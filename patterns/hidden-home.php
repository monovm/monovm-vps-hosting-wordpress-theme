<?php
/**
 * Title: Internal blog home content
 * Slug: monovm-blueprint/hidden-home
 * Categories: monovm-blueprint, posts
 * Description: Internal translatable content composition for the blog home template.
 * Viewport Width: 1280
 * Inserter: no
 */
?>
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-signal-color has-text-color has-technical-font-family has-small-font-size" style="letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'JOURNAL / LATEST', 'monovm-blueprint' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"level":1,"fontSize":"3-x-large"} -->
		<h1 class="wp-block-heading has-3-x-large-font-size"><?php echo esc_html__( 'Articles and guides', 'monovm-blueprint' ); ?></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"textColor":"muted","fontSize":"large"} -->
		<p class="has-muted-color has-text-color has-large-font-size"><?php echo esc_html__( 'Technical notes, comparisons, and practical infrastructure guidance.', 'monovm-blueprint' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-query alignwide" style="margin-top:var(--wp--preset--spacing--80)">
		...
		<!-- wp:query-no-results -->
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
				<!-- wp:heading {"level":2,"fontSize":"x-large"} --><h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'No articles yet', 'monovm-blueprint' ); ?></h2><!-- /wp:heading -->
				<!-- wp:paragraph {"textColor":"muted"} --><p class="has-muted-color has-text-color"><?php echo esc_html__( 'Publish a post to begin the journal.', 'monovm-blueprint' ); ?></p><!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		<!-- /wp:query-no-results -->
	</div>
