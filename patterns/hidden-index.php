 ...
 * Slug: monovm-blueprint/hidden-index
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group alignwide">
		...
		<h1 class="wp-block-heading has-3-x-large-font-size"><?php echo esc_html__( 'Latest content', 'monovm-blueprint' ); ?></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"textColor":"muted","fontSize":"large"} -->
		<p class="has-muted-color has-text-color has-large-font-size"><?php echo esc_html__( 'Browse articles, pages, and technical notes published on this site.', 'monovm-blueprint' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-query alignwide" style="margin-top:var(--wp--preset--spacing--80)">
		...
		<!-- wp:query-no-results -->
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
				<!-- wp:heading {"level":2,"fontSize":"x-large"} --><h2 class="wp-block-heading has-x-large-font-size"><?php echo esc_html__( 'No content found', 'monovm-blueprint' ); ?></h2><!-- /wp:heading -->
				<!-- wp:paragraph {"textColor":"muted"} --><p class="has-muted-color has-text-color"><?php echo esc_html__( 'Try a different search or use the navigation to explore the site.', 'monovm-blueprint' ); ?></p><!-- /wp:paragraph -->
				<!-- wp:search {"label":<?php echo wp_json_encode( __( 'Search', 'monovm-blueprint' ) ); ?>,"showLabel":false,"placeholder":<?php echo wp_json_encode( __( 'Search this site', 'monovm-blueprint' ) ); ?>,"buttonText":<?php echo wp_json_encode( __( 'Search', 'monovm-blueprint' ) ); ?>,"buttonUseIcon":false} /-->
			</div>
			<!-- /wp:group -->
		<!-- /wp:query-no-results -->
	</div>
