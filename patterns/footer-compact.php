 ...
 * Slug: monovm-vps/footer-compact
...
<div class="wp-block-group alignfull site-footer site-footer--compact has-ink-color has-canvas-background-color has-text-color has-background" style="border-top-color:var(--wp--preset--color--line);border-top-width:1px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group"><!-- wp:site-title {"level":0,"fontSize":"medium"} /--><!-- wp:paragraph {"textColor":"muted","fontSize":"small"} --><p class="has-muted-color has-text-color has-small-font-size"><?php echo esc_html__( 'Copyright notice — replace with your organization and year.', 'monovm-vps' ); ?></p><!-- /wp:paragraph --></div>
		<!-- /wp:group -->

		<!-- wp:navigation {"overlayMenu":"never","ariaLabel":<?php echo wp_json_encode( __( 'Legal navigation', 'monovm-vps' ) ); ?>,"layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right"},"fontSize":"small"} -->
			<!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Privacy', 'monovm-vps' ) ); ?>,"url":"#","kind":"custom","isTopLevelLink":true} /-->
			<!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Terms', 'monovm-vps' ) ); ?>,"url":"#","kind":"custom","isTopLevelLink":true} /-->
		<!-- /wp:navigation -->
	</div>
	<!-- /wp:group -->
</div>
