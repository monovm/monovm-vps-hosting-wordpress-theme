...
<div class="wp-block-group alignfull site-footer has-ink-color has-surface-background-color has-text-color has-background" style="border-top-color:var(--wp--preset--color--line);border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-columns alignwide">
		...
		<!-- wp:column {"width":"22%"} -->
		<div class="wp-block-column" style="flex-basis:22%"><!-- wp:heading {"level":2,"fontSize":"medium"} --><h2 class="wp-block-heading has-medium-font-size"><?php echo esc_html__( 'Support', 'monovm-blueprint' ); ?></h2><!-- /wp:heading --><!-- wp:paragraph {"textColor":"muted","fontSize":"small"} --><p class="has-muted-color has-text-color has-small-font-size"><?php echo esc_html__( 'Add your support hours and preferred contact route.', 'monovm-blueprint' ); ?></p><!-- /wp:paragraph --><!-- wp:navigation {"overlayMenu":"never","ariaLabel":<?php echo wp_json_encode( __( 'Support navigation', 'monovm-blueprint' ) ); ?>,"layout":{"type":"flex","orientation":"vertical"}} --><!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Documentation', 'monovm-blueprint' ) ); ?>,"url":"<?php echo esc_url( home_url( '/blog/' ) ); ?>","kind":"custom","isTopLevelLink":true} /--><!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Service status', 'monovm-blueprint' ) ); ?>,"url":"<?php echo esc_url( home_url( '/network-locations/' ) ); ?>","kind":"custom","isTopLevelLink":true} /--><!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Contact support', 'monovm-blueprint' ) ); ?>,"url":"<?php echo esc_url( home_url( '/support/' ) ); ?>","kind":"custom","isTopLevelLink":true} /--><!-- /wp:navigation --></div>
		<!-- /wp:column -->

		<!-- wp:column {"width":"22%"} -->
		<div class="wp-block-column" style="flex-basis:22%"><!-- wp:heading {"level":2,"fontSize":"medium"} --><h2 class="wp-block-heading has-medium-font-size"><?php echo esc_html__( 'Legal', 'monovm-blueprint' ); ?></h2><!-- /wp:heading --><!-- wp:navigation {"overlayMenu":"never","ariaLabel":<?php echo wp_json_encode( __( 'Legal navigation', 'monovm-blueprint' ) ); ?>,"layout":{"type":"flex","orientation":"vertical"}} --><!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Privacy policy', 'monovm-blueprint' ) ); ?>,"url":"<?php echo esc_url( home_url( '/about/' ) ); ?>","kind":"custom","isTopLevelLink":true} /--><!-- wp:navigation-link {"label":<?php echo wp_json_encode( __( 'Terms of service', 'monovm-blueprint' ) ); ?>,"url":"<?php echo esc_url( home_url( '/about/' ) ); ?>","kind":"custom","isTopLevelLink":true} /--><!-- /wp:navigation --></div>
		<!-- /wp:column -->
	</div>
	<!-- /wp:columns -->
	...
	<div class="wp-block-group alignwide">
		...
		<!-- wp:social-links {"iconColor":"ink","iconColorValue":"#EDF8F8","openInNewTab":true,"showLabels":false,"className":"is-style-logos-only"} --><ul class="wp-block-social-links has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"<?php echo esc_url( home_url( '/feed/' ) ); ?>","service":"feed"} /--></ul><!-- /wp:social-links -->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
