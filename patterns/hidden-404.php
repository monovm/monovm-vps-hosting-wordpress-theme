 ...
 * Slug: monovm-blueprint/hidden-404
...
<div class="wp-block-group alignwide error-404__panel has-border-color has-ink-color has-surface-background-color has-text-color has-background" style="border-color:var(--wp--preset--color--line);border-width:1px;margin-top:var(--wp--preset--spacing--90);margin-bottom:var(--wp--preset--spacing--90);padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--80)">
	...
	<p class="has-signal-color has-text-color has-technical-font-family has-small-font-size" style="letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'ERROR / 404', 'monovm-blueprint' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"level":1,"fontSize":"3-x-large"} -->
	<h1 class="wp-block-heading has-3-x-large-font-size"><?php echo esc_html__( 'Page not found', 'monovm-blueprint' ); ?></h1>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"textColor":"muted","fontSize":"large"} -->
	<p class="has-muted-color has-text-color has-large-font-size"><?php echo esc_html__( 'The requested address may have changed or may no longer be available. Search the site or use the primary navigation to continue.', 'monovm-blueprint' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:search {"label":<?php echo wp_json_encode( __( 'Search', 'monovm-blueprint' ) ); ?>,"showLabel":true,"placeholder":<?php echo wp_json_encode( __( 'Search this site', 'monovm-blueprint' ) ); ?>,"buttonText":<?php echo wp_json_encode( __( 'Search', 'monovm-blueprint' ) ); ?>,"buttonUseIcon":false,"style":{"spacing":{"margin":{"top":"var:preset|spacing|70"}}}} /-->
</div>
<!-- /wp:group -->
